...
namespace MultimediaCenter.Controllers
{
    ...
    public class ReservationsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAll()
        {
            ...
            var result = _context.Reservations.Where(r => r.ApplicationUser.Id == user.Id).Include(r => r.Movies).FirstOrDefault();
        ...
        public async Task<IActionResult> DeleteReservation(int id)
        {
            ...
            var reservations = _context.Reservations.Where(r => r.ApplicationUser.Id == user.Id && r.Id == id).FirstOrDefault();
